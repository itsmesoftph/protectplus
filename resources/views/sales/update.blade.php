...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item "  aria-current="page"><a href="{{ route('sales') }}">Order Listing</a></li>
            <li class="breadcrumb-item "  aria-current="page">Order Approval</li>
    ...
    <div class="container" style="width: 100%;">
        ...
        <div class="row no-print" >
            ...
            <div class="col ">
                <form action="{{ route('sales.update',$orders['id'])}}" method="post" id="checkout-form">
                        <div class="col-xs-3">
