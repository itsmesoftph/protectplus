...
class OrdersController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        event(new BreadDataUpdated($dataType, $data));
           ...
           // UPDATE TO PROCESSING ONCE PAID
    ...
    //    PROCESSING ORDER WITHOUH PAYMENT
        if($request['status'] === "processing" && $request['is_paid'] === null ){
                $message= 'Cannot process orders without payment';
                $title='NOT YET PAID';
        ...
        if($request['status'] === "decline"){
            ...
            foreach($orderItems as $orderItem){
                ...
                $productItem = Product::findOrFail($orderItem->product_id);

                $productItem->increment('quantity',$orderItem->quantity);
